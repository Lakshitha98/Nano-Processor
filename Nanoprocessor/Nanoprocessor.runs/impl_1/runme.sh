...
HD_PWD='C:/Users/Adithya/digital_design_labs/Nanoprocessor/Nanoprocessor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nanoprocessor_with_7_segment_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nanoprocessor_with_7_segment_display.tcl -notrace
