...
HD_PWD='C:/Users/Adithya/digital_design_labs/Nanoprocessor/Nanoprocessor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nanoprocessor_with_7_segment_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nanoprocessor_with_7_segment_display.tcl
